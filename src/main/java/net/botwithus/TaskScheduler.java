...
public class TaskScheduler {
   ...
   public static int pin1 = 0;
    ...
    public static HashMap<Integer, Integer> pinComponents = new HashMap<>();
    public static HashMap<Integer, Integer> dialogComponents = new HashMap<>();
    ...
    public static void bankPin() {
        if (Interfaces.isOpen(759)) {
            ...
            for (int i = 0; i < bankPin.length; i++) {
                int pin = bankPin[i];
                log("Interacting with pin number: " + pin);
                if (i == 3) {
